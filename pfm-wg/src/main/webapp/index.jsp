...
<script language="javascript" type="text/javascript">
 ...
 var map;
var findAllPackagesURL = "http://localhost:8080/pfm/rest/package/findAllPackages";
...
function initPage() {
	...
	var rowFilter = createRowFilter(0,15);
	$.ajax({
        type: "POST",
        url: "http://localhost:8080/pfm/rest/package/findAllPackagesByStatus",
